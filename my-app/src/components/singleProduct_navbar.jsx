const SingleProduct_navbar = () => {
    return (
        <div class ="flex items-center h-[175px] w-full bg-[#F7F8FB] text-[#000000] justify-around">
            <h2 class = "text-[28px] font-bold pr-[250px]">Product Detail</h2>
            <div class= "flex">
                ...
                <p class= "text-[14px] text-[#575A5E] flex justify-center items-center gap-2 ">Product Detail
...
export default SingleProduct_navbar
