    ...
    return (
        <div class ="h-[800px] bg-[#ffffff] w-full">    
            <div class = "flex h-[600px] py-[100px] justify-center gap-6">
                <div class ="border-2  h-[602px] w-[544px]">
                    <img src="/banner7.jpg" alt="photo" class="h-[602px] w-[544px]"/>
                </div>

                <div class ="flex flex-col h-[600px] w-[544px] gap-3">
                    <h1 class ="text-[#000000] font-medium text-[23px] hover:text-[#FF324D] transition-all duration-300">Blue Dress For Woman</h1>
                    <div class = "flex justify-between items-center">
                        <div class ="flex gap-2 items-center">
                            <p class ="text-[#FF324D] font-bold text-[25px]">$45.00</p>
                            <del class ="text-[13px] text-[#76818F]">$55.25</del>
                            <p class ="text-[#388E55] text-[13px]">35% Off</p>   
                        </div>
                        <p class ="text-[#76818F] text-[14px]">(21)</p>
                    </div>
                    <div class ="text-[#76818F] text-[15px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc id varius nunc.</div>
                    ...
                    <Sizes />
                    {/* <p class = "w-[510px] bg-[#acbcd1] h-[1px]"></p> */}
                    <div class ="flex items-center gap-4 border-y p-4">
                        <Plus_mins />
                        <a className='button_four text-[#ffffff] bg-[#FFffff] flex items-center justify-center overflow-hidden border rounded-lg border-[#FF324D] w-[191px] h-[50px]'>
                            Add To Cart
                        </a>
                        <svg
